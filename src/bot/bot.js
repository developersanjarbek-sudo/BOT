...
// Setup Scenes
const stage = new Scenes.Stage([addMovieScene, broadcastScene, vipScene, reviewScene, requestScene, reportScene, promoWizard, redeemSchema, editMovieScene, autoPostSettingsScene, mandatorySubscriptionScene]);
