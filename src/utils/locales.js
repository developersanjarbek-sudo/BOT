export const locales = {
    uz: {
        ...
        bonus_claimed: "🎁 <b>Tabriklaymiz!</b>\n\nSizga +25 ball berildi!\nHozirgi balingiz: {points}",
        bonus_cooldown: "⏳ <b>Shoshmang!</b>\n\nKeyingi bonusni {hours} soat {minutes} daqiqadan so'ng olishingiz mumkin.",

        referral_promo: "🗣 <b>Do'stlarni taklif qiling!</b>\n\nHar 10 ta do'stingiz uchun <b>24 soat VIP</b> oling!\n\n🔗 Sizning havolangiz:\n<code>{link}</code>",
        referral_progress: "👤 <b>Yangi do'st qo'shildi!</b>\n\nJami takliflar: {count} ta.\n🎉 24 soatlik VIP olish uchun yana <b>{left} ta</b> do'st taklif qiling.",
        ...
        // Subscription
        sub_check_msg: "🚫 <b>Botdan foydalanish uchun quyidagi kanallarga a'zo bo'ling:</b>",
